...
<!--Navbar-->
	...
	<div class="container">
		...
		<span style="font-size:25px; color:blue"><center><strong>สร้างบัญชีผู้ใช้</strong></center></span>	
			<span class="pull-left"><a href="#addnew" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> เพิ่มข้อมูล</a></span>
			<div style="height:50px;"></div>
				...
				<?php
					...
					while($row=mysqli_fetch_array($query)){
						...
						<tr>
							...
							<td>
								<a href="#edit<?php echo $row['userid']; ?>" data-toggle="modal" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> แก้ไข</a> || 
								<a href="#del<?php echo $row['userid']; ?>" data-toggle="modal" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> ลบ</a>
